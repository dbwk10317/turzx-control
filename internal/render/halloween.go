...
func halloweenDashboardOverlay(d Dashboard, elapsed time.Duration, counter uint64, preview bool) ([]byte, error) {
	...
	drawProviderLabel(img, 438, 78, "CODEX", d.Codex.Account, 20, 24, halloweenColumn, halloweenGold, halloweenMuted)
	drawProviderLabel(img, 858, 78, "CLAUDE", d.Claude.Account, 20, 24, halloweenColumn, halloweenViolet, halloweenMuted)
