...
W,H=1920,462
def frame(detail,i):
    img=Image.new("RGBA",(W,H),(8,10,16,255)); d=ImageDraw.Draw(img); r=random.Random(i*7+detail)
    for k in range(detail):
        x=(k*97+i*13)%W
        d.rectangle([x,r.randrange(H),x+r.randrange(4,40),H], fill=(r.randrange(256),r.randrange(256),200,255))
